...
public class AzureProbeMonitorConfigurationTest {
    private AzureConfiguration azureConfiguration = new AzureConfiguration(
        "subscription-id", new AzureConfiguration.ServicePrincipal("tenant-id", "client-id",
        "client-secret", null));

    private List<NvaConfiguration> nvaConfigurations = Arrays.asList(
    ...
    private List<NamedResourceId> publicIpAddresses =
    ...
    void test_null_nva_configurations() {
        Assertions.assertThrows(NullPointerException.class,
            () -> new AzureProbeMonitorConfiguration(this.azureConfiguration,
    ...
    void test_duplicate_route_ids() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class,
            () -> new AzureProbeMonitorConfiguration(this.azureConfiguration,
                this.nvaConfigurations, invalidRouteTableIds, null, null, null, null));
    }
    ...
    void test_duplicate_public_ip_address_names() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class,
            () -> new AzureProbeMonitorConfiguration(this.azureConfiguration,
                this.nvaConfigurations, null, invalidPublicIpAddresses, null, null, null));
    }
    ...
    void test_null_defaults() {
        AzureProbeMonitorConfiguration azureProbeMonitorConfiguration =
            new AzureProbeMonitorConfiguration(this.azureConfiguration,
                this.nvaConfigurations, this.routeTables, this.publicIpAddresses,
                null, null, null);
    ...
    void test_valid_parameters() {
        ...
        Assertions.assertEquals(this.azureConfiguration,
            azureProbeMonitorConfiguration.getAzureConfiguration());
        Assertions.assertEquals(this.nvaConfigurations,
            azureProbeMonitorConfiguration.getNvaConfigurations());
        Assertions.assertEquals(this.routeTables,
            azureProbeMonitorConfiguration.getRouteTables());
        Assertions.assertEquals(this.publicIpAddresses,
